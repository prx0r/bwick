...
Start: `VISION.md` (thesis) → `STACK.md` (locked SKUs, margins, suppliers) →
`docs/` (build specs) → `engine/` (run it). Ideas incubate in `ideas.md`;
graduate to `docs/products.md` or die with a reason.
