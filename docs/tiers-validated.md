...
Etsy market pages, Printify 2026 report). Figures are total sales per listing
unless noted weekly. Prodigi/Makr3D fulfilment unchanged — see
prodigi-tiers.md, makr3d.md.

## S tier — confirmed (proven volume + our pipeline ready)

| SKU | Etsy evidence | Our edge |
|---|---|---|
...
| SKU | Etsy evidence | Note |
|---|---|---|
| Calendars | Office/family calendars 19.9k @ $43 (!), 3.4k @ $58, 3.3k @ $60; pet wall calendar 243 @ $28 | **Q4 timing: 2027 calendars sell Oct–Dec — "12 months of Buster" is now-or-never; argue S for Q4** |
| Framed prints / wall art | Custom dog nursery prints (strong reviews); printable wall art top-2026 (Printify) | fine-art stock, premium frame |
| Photo book | Wedding planner adjacents 11.1k; keepsake logic identical | "Year in Roasts" retention hook |
| Phone cases / cushions / pet apparel | Custom pet shirt 4.75k (~$49K revenue); dog bandana shop 37.2k sales | fan-merch wave 2, after character has fans |

## B tier — conditional (demand exists, we have no edge or timing wrong)

- Apparel (tees/hoodies): category #1 overall (1.6k sweatshirt) BUT most competitive
...
MOQ/stock (violates zero-inventory), slow-dispatch labs (kills Q4 promise),
unproofed colour-critical fine-art (sample first).

## What changed vs the unvalidated tiers
